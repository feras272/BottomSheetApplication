 ...
 * Use the [ChooseScaleDetailsFragment.newInstance] factory method to
...
class ChooseScaleDetailsFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ChooseScaleDetailsFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ChooseScaleDetailsFragment().apply {
